          ...
          <form className="p-2" onSubmit={onSubmitHandler}>
            <div className="flex items-center gap-2">
              ...
              <div className="w-full grid grid-cols-2 gap-2">
                <div className="col-span-1 relative">
                  ...
                  {titleError.length > 0 && (<small className="text-red-500">{titleError}</small>)}
                </div>
                <div className="col-span-1 relative">
                  <div className=" bg-white p-3 shadow-md focus-within:border-purple-500 focus-within:border-b">
                    <input
                  ...
                  {dateError.length > 0 && (<small className="text-red-500">{dateError}</small>)}
                </div>
            ...
            <div className="flex items-center gap-2 mt-2 w-full">
              ...
              <div className="w-full">
                ...
                ></textarea>
                  {descriptionError.length > 0 && (<small className="text-red-500">{descriptionError}</small>)}
              </div>
            </div>
